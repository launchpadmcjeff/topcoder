...
public class IslandFerriesTest {
	...
	public void testCosts2() {
		...
		int[] expecteds = { 1,  12,  112 };
		int[] actuals = sut.costs(legs, prices);
		assertEquals(expecteds, actuals);
	}
	
	@Test
	public void testCosts3() {
		String[] legs = { "1-0" };
	...
	public void testCosts4() {
		...
		int[] expecteds = { 170,  160,  155,  173,  145,  150,  158,  168,  153,  145,  162,  88,  162,  86,  163,  159,  153,  150,  104 };
		int[] actuals = sut.costs(legs, prices);
		assertEquals(expecteds, actuals);
	}
